...
start_date = datetime(2024, 09, 30)
default_args = { 
    'owner': 'mrh', 
...
def generate_account_dim_data():
    ...
    while row_num <= num_rows: 
        account_id, account_types, status, customer_id, balance, opening_date_millis = generate_random_data(row_num)
...
with DAG('d_account_generator', default_args=default_args,description='Generate large account dimensions data in a CSV file', schedule_interval=timedelta(days=1), start_date=start_date, tags=['schema']) as dag:
